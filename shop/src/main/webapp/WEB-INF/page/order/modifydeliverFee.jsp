...
<form action="/shop/control/order/modifyDeliverFee.do" method="post" onsubmit="return checkfm(this)">
<input type="hidden" name="orderid" value="${param.orderid}"/>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4"><td colspan="2"  > <font color="#FFFFFF">修改配送费：</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" align="right"> 配送费：</td>
      <td width="78%"> <input type="text" name="fee" value="${fee}" size="10" maxlength="5"/>
        <font color="#FF0000">*</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
       <td></td>
      <td align="left"> <input type="submit" name="SYS_SET" value=" 确 定 " class="frm_btn"></td>
    </tr>
  </table>
</form>
<br>
