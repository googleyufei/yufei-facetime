	...
	if(username.trim()!=""){
		...
		if(usernameview){
			send_request(function(value){usernameview.innerHTML=value},
					 '/shop/control/employee/exist.do?username='+ username, true);
		}
	}
}
...
<form action="/shop/control/employee/reg.do" method="post" enctype="multipart/form-data" onsubmit="return checkfm(this)">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="radio" name="gender" value="0">男
