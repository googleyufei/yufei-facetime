...
<SCRIPT LANGUAGE="javascript" src="/shop/provinceArea.js" type="text/javascript"></SCRIPT>
<SCRIPT language=javascript src="/shop/FoshanRen.js"></SCRIPT>
...
<form action="/shop/customer/shopping/saveDeliverInfo.do" method="post">
<input type="hidden" name="directUrl" value="${param.directUrl }">
<TABLE cellSpacing=0 cellPadding=0 align="center" border=0>
  <TBODY>
  <TR>
    <TD><IMG src="/shop/images/global/logo.gif" >   &nbsp;&nbsp;<IMG height=36 src="/shop/images/buy/az-s-checkout-shipping-bann.gif" > </TD></TR></TBODY></TABLE><BR>
    ...
    <TD>
      ...
      <TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
        ...
        <TR>
          ...
          <TD><input type="text" name="recipients" maxlength="8" size="30"/><FONT color="#ff0000">*</FONT>&nbsp;<input type="radio" name="gender" value="MAN"/>先生 <input type="radio" name="gender" value="WOMEN"/>女士</TD></TR>
        <TR>
          <TD height="27">
            <DIV align="right">收货人地址<span id="AddressLable"></span>： </DIV></TD>
          <TD><input type="text" name="address" maxlength="100" size="60"/><FONT 
            color="#ff0000">*</FONT></TD></TR>
        <TR>
          <TD height="27">
            <DIV align="right">电子邮件<span id="EmailLable"></span>：</DIV></TD>
          <TD><input type="text" name="email" maxlength="45" size="30"/><FONT color="#ff0000">*</FONT></TD></TR>
        <TR>
          <TD height="27">
            <DIV align="right">邮政编码<span id="PostalcodeLable"></span>：</DIV></TD>
          <TD><input type="text" name="postalcode" maxlength="6" size="20"/><FONT 
        ...
        <TR>
          ...
          <TD><input type="text" name="mobile" maxlength="15" size="20"/> 
<font color="#484848">（手机和电话至少有一项必填）</font></TD></TR>
        <TR>
          <TD>
            <DIV align="right">购买人与收货人是否相同<FONT color="#ff0000">*</FONT>：</DIV></TD>
          <TD><input type="radio" name="buyerIsrecipients" value="true" onclick="javascript:buyerinfoSelect(this.value)"/> <b>相同</b>
		  <input type="radio" name="buyerIsrecipients" value="false" onclick="javascript:buyerinfoSelect(this.value)"/> <b>不相同</b> </TD>
        </TR>
		  <!---------------------------->
        <TR id="buyerinfoInput" style="DISPLAY: none">
		  ...
		  <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
            <TR>
              ...
              <TD align="left"><input type="text" name="buyer" maxlength="8" size="30" />
              &nbsp;<input type="radio" name="buyer_gender" value="MAN" />先生 <input type="radio" name="buyer_gender" value="WOMEN"/>女士</TD>
            </TR>
            <TR>
              <TD align="right" height="25"><FONT color="#f47a22">*</FONT> 详细地址：</TD>
              <TD align="left"><input type="text" name="buyer_address" maxlength="100" size="60" />
              </TD>
            </TR>
            <TR>
              ...
              <TD><TABLE cellSpacing="0" cellPadding="0" border="0">
                  <TR>
                    <TD align="left" height="20"><input type="text" name="buyer_postalcode" maxlength="6" size="20"/>
                    </TD>
        ...
        <TR>
          <TD colSpan=2 align="center"><IMG onClick="javascript:sendForm()" src="/shop/images/buy/az-sfl-shipping-to-this-boo.gif" vspace=5 border=0 style="CURSOR: hand;"></TD></TR>
