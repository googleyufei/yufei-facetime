...
<link href="/shop/css/global/paymentway.css" rel="stylesheet" type="text/css">
...
<TABLE cellSpacing=0 cellPadding=0 align=center border=0>
  <TBODY>
  <TR>
    <TD><IMG src="/shop/images/global/logo.gif" > 
	&nbsp;&nbsp;<IMG height=36 src="/shop/images/buy/az-s-checkout-payment-banne.gif" > 
	</TD>
  </TR>
  </TBODY>
</TABLE>
<BR>
<form action="/shop/customer/shopping/savePaymentway.do" method="post">
...
<SPAN class=h1><STRONG>请选择您的送货与支付方式:</STRONG></SPAN> 
      <TABLE height=31 cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD>
            <DIV align=right><IMG onClick="javascript:sendForm()" height="22" src="/shop/images/buy/az-sfl-shipping-to-this-boo.gif" vspace=5 border=0 style="CURSOR: hand;">
        </DIV></TD></TR>
	 </TBODY></TABLE>
<A name="deliverway"></A>
          ...
          <TD bgColor="#ffffff">
            <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
              ...
              <TR bgColor="#eeeecc">
				...
				<tr>
				<TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="deliverway" value="EXPRESSDELIVERY" onclick="javascript:paymentwaySelect(this.value)"/></TD>
        ...
        <TR>
          <TD bgColor=#ffffff>
            <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
			 ...
			 <TR>
                <TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="paymentway" value="NET" /> </TD>
                <TD vAlign="middle" ><B>网上支付</B>  易宝支付</TD>
			  </TR>
              <TR id="paymentway_COD" >
                <TD class="big14" vAlign="middle" align="right" width="10%">
                <input type="radio" name="paymentway" value="COD"/> </TD>
                <TD><B>货到付款</B></TD>
			  </TR>
			  <TR>
                <TD class="big14" vAlign="middle" align="right" width="10%">
                  <input type="radio" name="paymentway" value="BANKREMITTANCE"/> </TD> 
                <TD><B>银行电汇</B>  开户名: 北京惠利至易高科技发展有限公司<BR>开户行名称: 交通银行上地支行<BR>银行帐号: 110060974018001084072</TD></TR>
              <TR>
