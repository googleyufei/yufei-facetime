...
<form action="/shop/control/product/add.do" enctype="multipart/form-data" method="post">
...
<input type="hidden" name="typeid"/>
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"> <input type="text" name="type_name" disabled="disabled" size="30"/> 
        <input type="button" name="select" value="选择..." onClick="javaScript:winOpen('/shop/control/product/type/selectUI.do','列表',600,400)">(<a href="/shop/control/product/type/addUI.do">添加产品类别</a>)
      </td>
    </tr>
	<tr bgcolor="f5f5f5"> 
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%">
        ...
        </select>(<a href="/shop/control/product/brand/addUI.do" target="_self">添加品牌</a>)</td>
    </tr>
	<tr bgcolor="f5f5f5"> 
