...
<form action="/shop/control/product/list.do" method="post">
...
<input name="query" value="true" type="hidden">
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"> <input type="text" name="v_type_name" disabled size="30" value="${typename}"/> 
        <input type="button" name="select" value="选择..." onClick="javaScript:winOpen('/shop/control/product/type/selectUI.do','列表',600,400)">
      </td>
    </tr>
	<tr bgcolor="f5f5f5"> 
...
在<input type="text" name="startbaseprice" size="10" maxlength="10" onkeypress="javascript:InputLongNumberCheck()"/>
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"> <select name="brandid">
          ...
          <c:forEach items="${brands}" var="brand"></c:forEach>
