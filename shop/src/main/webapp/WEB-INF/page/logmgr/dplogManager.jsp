...
<html>
    ...
    <body topmargin="0">
       <%@ include file="/inc/navigationBar.inc"%>
        ...
        <iframe src="dplog.do?action=query" id="surveyReportWin1" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0" border="0" scrolling="auto" noresize></iframe>
                        </td>
                    </tr>
                </table>
            </form>
