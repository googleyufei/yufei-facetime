        ...
        <div id="logmgr_list" tabLebel="<%=CURRENT_MENU_ITEM%>">
            <form>
            	<table width="100%" height="100%" cellSpacing="0" cellPadding="0" border="0">
                  ...
                  <iframe src="/shop/pages/sysloginlog/list.do" id="surveyReportWin1" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0" border="0" scrolling="auto" noresize></iframe>
                        </td>
                    </tr>
                </table>
            </form>
