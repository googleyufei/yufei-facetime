...
<html>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>system operator manager</title>
    ...
    <body topmargin="0">
       <%@ include file="/inc/navigationBar.inc"%>
        ...
        <div id="logmgr_list" tabLebel="<%=CURRENT_MENU_ITEM%>">
            <form>
            	<table width="100%" height="100%" cellSpacing="0" cellPadding="0" border="0">
                    <tr>
                        <td align="left" height="100%">
            <iframe src="/shop/pages/sysoperlog/list.do" id="operLog" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0" border="0" scrolling="auto" noresize></iframe>
                        </td>
                    </tr>
                </table>
            </form>
