...
<html>
<head><title><spring:message code="orginfo.modifyinfo"/> </title></head>
...
<tr>
	<td class="oracolumncenterheader" colspan="2" height="24"><spring:message code="orginfo.modifyinfo" bundle="org"/> 
	</td>
</tr>
<tr>
...
<tr>
	...
	<td class="oracletdone">${orgInfoForm" property="orgid" /><html:hidden property="orgid}</td>
</tr>
<tr>
	<td height="24" class="oracletdtwo" align="right">
...
<tr>
	...
	<logic:notEmpty name="orgInfoForm" property="unionorgid"> 
        <script language="javascript">
			orgInfoForm.unionorgid.value='${orgInfoForm.unionorgid}';
		</script>
    </logic:notEmpty>
	</td>
</tr>
<tr>
	...
	<td class="oracletdone">
        ...
        <logic:notEmpty name="orgInfoForm" property="areaid"> 
        <script language="javascript">
			orgInfoForm.areaid.value='${orgInfoForm.areaid}';
		</script>
        </logic:notEmpty>
	</td>
</tr>
...
<tr>
	<td colspan="2" bgcolor="#FFFFFF" height="24" align="center">
		<input type="button" name="btnModify" value='<spring:message code="button.modify"/> ' class="MyButton" id="btnModify" accesskey="M" onClick="saveOrg()" image="/shop/images/share/save.gif">
...
<tr>
	...
	<td bgcolor="#FFFFFF" valign="top">
		...
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="2" height="100%">
				...
				<tr>
					<td valign="top">
			1、<spring:message code="orginfo.desc1"/> <br>
            2、<spring:message code="orginfo.desc2" bundle="org"/>“<font color="#FF0000">**</font>”<bean:message  key="orginfo.desc3"/> <br>
            3、<spring:message code="orginfo.desc4"/> 
					</td>
				</tr>
			</table>
		</div>
