...
<tr>
	<td class="oracolumncenterheader" colspan="2" height="24"><spring:message code="geogarea.addinfo" bundle="geog"/> 
	</td>
</tr>
<tr>
...
<tr>
	...
	<td class="oracletdone"><html:text property="areaid" style="width:98%"/></td>
</tr>
<tr>
	<td height="24" class="oracletdtwo" align="right">
