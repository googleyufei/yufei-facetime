...
<html>
    ...
    <body topmargin="0">
        ...
        <div id="pwdsave" tabLebel='<spring:message code="main.ui.pass"/>'>
        <form>
            <table width="100%" height="100%" cellSpacing="0" cellPadding="0" border="0">
            <tr>
               <td align="left" height="100%">
               <iframe src="pwdSetting.jsp" id="addOper" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0" border="0" scrolling="auto" noresize>
			   </iframe>
               </td>
            </tr>
            </table>
