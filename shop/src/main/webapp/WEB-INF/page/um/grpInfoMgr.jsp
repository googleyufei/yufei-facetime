...
<html>
	...
	<div id="grpList" tabLebel="<%=CURRENT_MENU_ITEM%>">
	<form name="grpLstForm">
		<table width="100%" height="100%" cellSpacing="0" cellPadding="0" border="0">
		<tr>
			<td align="left" height="100%">
        <iframe src="/shop/pages/um/grpinfo/list.do" id="grpList" name="grpList" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0" border="0" scrolling="auto" noresize></iframe>
            </td>
        </tr>
     </table>
     </form>
