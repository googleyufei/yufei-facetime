...
<form  name="roleInfoForm" action="/shop/pages/um/roleinfo/add.do" method="post">
<table border="0" cellpadding="1" width="100%" cellspacing="1" class="tablebg" align="center">
<tr>
	<td class="oracolumncenterheader" colspan="2" height="24"><spring:message code="roleInfo.addRole" />
	</td>
</tr>
<tr>
	<td height="24" width="35%" class="oracletdtwo" align="right">
		<font color="#FF0000">**</font><spring:message code="roleInfo.addRoleName" />
	</td>
	<td width="65%" class="oracletdone">
		<input type="text" name="rolename" style="width:97%">
	</td>
</tr>
<tr>
...
<tr>
	<td colspan="2" bgcolor="#FFFFFF" height="24" align="center">
		<input type="button" name="ok"  value='<spring:message code="button.save"/>' class="MyButton" accesskey="O" onClick="roleInfoForm.submit()" image="/shop/images/share/save.gif"> 
