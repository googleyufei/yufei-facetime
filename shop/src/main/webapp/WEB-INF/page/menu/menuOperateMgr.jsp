...
<html>
	...
	<table id="JtsPool_demo" cellSpacing="0" cellPadding="0" width="100%" height="96%">
        ...
        <div id="div1" tabLebel="<%=CURRENT_MENU_ITEM%>">
            <form>
            	<table width="100%" height="100%" cellSpacing="0" cellPadding="0" border="0">
                    <tr>
                        <td align="left" height="100%">
                            <iframe src="/shop/pages/menuoperate/list.do" id="main" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0" border="0" scrolling="auto" noresize></iframe>
                        </td>
                    </tr>
                </table>
            </form>
