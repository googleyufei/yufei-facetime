 ...
 */
public class AmqConsumer implements HttpSessionActivationListener, HttpSessionBindingListener {
	...
	private static final Log LOG = LogFactory.getLog(AmqConsumer.class);
	...
	protected static AmqConsumer createWebClient(HttpServletRequest request) {
		return new AmqConsumer();
	}
