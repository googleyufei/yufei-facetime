...
/**
 * Used in a wide variety of org.streets.commons.resource searches. Generates a series of getName variations from a path (which must include a
 * suffix) and locale.
 * <p/>
...
public class LocalizedNameGenerator implements Iterator<String>, Iterable<String> {
    ...
    public LocalizedNameGenerator(String path, Locale locale) {
        ...
        // When there is no dot in the getName, pretend it exists after the
        ...
        while (state != EXHAUSTED) {
            ...
            switch (state) {
                ...
                case LV:
                    ...
                    if (StringUtils.isBlank(variant) || StringUtils.isBlank(country)) continue;
    ...
    /**
     * Returns true if there are more getName variants to be returned, false otherwise.
     */
    ...
    public static void main(String[] args) {
        LocalizedNameGenerator lng = new LocalizedNameGenerator("org/streets/commons/FooBar.properties", Locale.getDefault());
        while(lng.hasNext()) {
            System.out.println(lng.next());
        }
    }
