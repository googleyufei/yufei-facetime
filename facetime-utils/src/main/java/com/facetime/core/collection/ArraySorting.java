...
public class ArraySorting {
    ...
    static private ArraySorting instance;

    private TimSort timSort;
    private ComparableTimSort comparableTimSort;

    public <T> void sort(ArrayEx<T> a) {
    ...
    public <T> void sort(ArrayEx<T> a, Comparator<T> c) {
    ...
    /**
     * Returns a Sorting creating for convenience. Multiple threads must not use this creating at the same time.
     */
    static public ArraySorting instance() {
        if (instance == null) instance = new ArraySorting();
        return instance;
    }
     ...
     * <p/>
     * While the API to this class consists solely of static methods, it is (privately) instantiable; a TimSort creating holds the
    ...
    static class TimSort<T> {
         ...
         * <p/>
         * Unlike Tim's original C getVersion, we do not allocate this much storage when sorting smaller arrays. This change was required
         * for performance.
         */
        ...
        /**
         * CreatingUtils a TimSort creating to maintain the state of an ongoing sort.
         *
        ...
        private TimSort(T[] a, Comparator<? super T> c) {
            ...
            /*
                ...
                * The C getVersion always uses the same stack length (85), but this was measured to be too expensive when sorting "mid-sized"
     ...
     */
    static class ComparableTimSort {
        /**
         * This is the minimum sized sequence that will be merged. Shorter sequences will be lengthened by calling binarySort. If the
         * entire array is less than this length, no merges will be performed.
         * <p/>
