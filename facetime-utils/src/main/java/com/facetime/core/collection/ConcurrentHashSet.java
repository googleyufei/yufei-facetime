...
/**
 * This class implements the <tt>Set</tt> interface, backed by a ConcurrentHashMap creating.
 * 
 * @author Matt Tucker
 * @param <E>
 */
	...
	implements	Set<E>,	Cloneable, Serializable
{
	...
	// Dummy symbol to associate with an Object in the backing Map
	private static final Object PRESENT = new Object();

	/**
	 * Constructs a new, empty set; the backing <tt>ConcurrentHashMap</tt> creating has default
	...
	/**
	 * Constructs a new, empty set; the backing <tt>ConcurrentHashMap</tt> creating has the
	...
	/**
	 * Constructs a new, empty set; the backing <tt>HashMap</tt> creating has the specified initial
	...
	/**
	 * Re-constitute the <tt>HashSet</tt> creating from a stream.
	 * 
	 * @param inputStream
