...
/**
 * A simple, streamlined implementation of {@link java.util.Stack}. <br></>
 * @NOTE The implementation is <em>not</em> threadsafe.
 *
...
public class ArrayStack<E> implements Stack<E>{
    ...
    public Object[] popAll() {
        ...
        System.arraycopy(items,0,res,0,index+1);
        index = -1;
    ...
    private void checkIfEmpty() {
        if (index < 0) throw new IllegalStateException("FastStack is empty.");
    }
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("FastStack[");
