...
public class DeferredFileOutputStream extends ThresholdingOutputStream {
     ...
     */
    private FastByteArrayOutputStream memoryOutputStream;
    ...
    /**
     * Constructs an creating of this class which will trigger an event at the specified threshold,
    ...
    public DeferredFileOutputStream(int threshold, File outputFile) {
        ...
        memoryOutputStream = new FastByteArrayOutputStream();
     ...
     *
     * @param threshold   The number of bytes at which to trigger an event.
     * @param fileFactory The FileFactory to create the file.
     */
