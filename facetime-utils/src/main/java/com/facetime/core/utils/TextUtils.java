...
public class TextUtils {
	...
	/**
	 * <p>
	 * <code>TextUtils</code> instances should NOT be constructed in standard
	 * programming. Instead, the class should be used as
	 * <code>TextUtils.wrap("foo bar", 20);</code>.
	 * </p>
	 * 
	 * <p>
	 ...
	 * width. Note that this methods works with <b>lines</b> only!
	 */
	...
	public static String wrap(String str, int wrapLength, String newLineStr, boolean wrapLongWords) {
		...
		int offset = 0;
		StringBuilder wline = new StringBuilder(inputLineLength + 32);
		...
		while ((inputLineLength - offset) > wrapLength) {
			...
			if (spaceToWrapAt >= offset) {
				// normal case
				wline.append(str.substring(offset, spaceToWrapAt));
				wline.append(newLineStr);
				...
				if (wrapLongWords) {
					...
					wline.append(str.substring(offset, wrapLength + offset));
					wline.append(newLineStr);
					offset += wrapLength;
				} else {
					...
					if (spaceToWrapAt >= 0) {
						...
						wline.append(str.substring(offset));
	 ...
	 * TextUtils.capitalize("i am FINE") = "I Am FINE"
	 * </pre>
	 * 
	 * @param str
	 ...
	 * TextUtils.capitalize(null, *)            = null
	 * TextUtils.capitalize("", *)              = ""
	 * TextUtils.capitalize(*, new char[0])     = *
	 * TextUtils.capitalize("i am fine", null)  = "I Am Fine"
	 * TextUtils.capitalize("i aM.fine", {'.'}) = "I aM.Fine"
	 * </pre>
	 * 
	 * @param str
	 ...
	 * 
	 * <pre>
	 * TextUtils.capitalizeFully(null)        = null
	 * TextUtils.capitalizeFully("")          = ""
	 * TextUtils.capitalizeFully("i am FINE") = "I Am Fine"
	 * </pre>
	 * 
	 * @param str
	 *            the String to capitalize, may be null
	 ...
	 * TextUtils.capitalizeFully(null, *)            = null
	 * TextUtils.capitalizeFully("", *)              = ""
	 * TextUtils.capitalizeFully(*, null)            = *
	 * TextUtils.capitalizeFully(*, new char[0])     = *
	 * TextUtils.capitalizeFully("i aM.fine", {'.'}) = "I am.Fine"
	 * </pre>
	 * 
	 * @param str
	 ...
	 * TextUtils.uncapitalize("I Am FINE") = "i am fINE"
	 * </pre>
	 * 
	 * @param str
	 ...
	 * TextUtils.uncapitalize(null, *)            = null
	 * TextUtils.uncapitalize("", *)              = ""
	 * TextUtils.uncapitalize(*, null)            = *
	 * TextUtils.uncapitalize(*, new char[0])     = *
	 * TextUtils.uncapitalize("I AM.FINE", {'.'}) = "i AM.fINE"
	 * </pre>
	 * 
	 * @param str
	 ...
	 * 
	 * <pre>
	 * TextUtils.initials(null)             = null
	 * TextUtils.initials("")               = ""
	 * TextUtils.initials("Ben John Lee")   = "BJL"
	 * TextUtils.initials("Ben J.Lee")      = "BJ"
	 * </pre>
	 * 
	 * @param str
	 ...
	 * TextUtils.initials(null, *)                = null
	 * TextUtils.initials("", *)                  = ""
	 * TextUtils.initials("Ben John Lee", null)   = "BJL"
	 * TextUtils.initials("Ben J.Lee", null)      = "BJ"
	 * TextUtils.initials("Ben J.Lee", [' ','.']) = "BJL"
	 * TextUtils.initials(*, new char[0])         = ""
	 * </pre>
	 * 
	 * @param str
	 *            the String to get initials from, may be null
