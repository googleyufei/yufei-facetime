...
public class SystemUtils {
	 ...
	 * </p>
	 * <p>
	 * Holds a class getName, on Windows XP this is <code>sun.awt.windows.WToolkit</code>.
	 * </p>
	 * <p>
	 * <b>On platforms without a GUI, this symbol is <code>null</code>.</b>
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 * </p>
	 * 
	 * <p>
	 * This symbol is initialized when the class is loaded. If {@link System#setProperty(String,String)} or
	 * {@link System#setProperties(java.util.Properties)} is called after this class is loaded, the symbol will be out of sync with that
	 * System property.
	 * </p>
	 * 
	 * @since 2.1
	...
	/**
	 * <p>
	 * The <code>java.awt.headless</code> System Property. The symbol of this property is the String <code>"true"</code> or
	 * <code>"false"</code>.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * The <code>java.class.getVersion</code> System Property. Java class format getVersion number.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.1
	 */
	public static final String JAVA_CLASS_VERSION = getSystemProperty("java.class.getVersion");

	/**
	 * <p>
	 * The <code>java.compiler</code> System Property. Name of JIT compiler to use. First in JDK getVersion 1.2. Not used in Sun JDKs after
	 * 1.2.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * The <code>java.runtime.getName</code> System Property. Java Runtime Environment getName.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.3
	 */
	public static final String JAVA_RUNTIME_NAME = getSystemProperty("java.runtime.getName");

	/**
	 * <p>
	 * The <code>java.runtime.getVersion</code> System Property. Java Runtime Environment getVersion.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.3
	 */
	public static final String JAVA_RUNTIME_VERSION = getSystemProperty("java.runtime.getVersion");

	/**
	 * <p>
	 * The <code>java.specification.getName</code> System Property. Java Runtime Environment specification getName.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.2
	 */
	public static final String JAVA_SPECIFICATION_NAME = getSystemProperty("java.specification.getName");
	...
	/**
	 * <p>
	 * The <code>java.specification.getVersion</code> System Property. Java Runtime Environment specification getVersion.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.3
	 */
	public static final String JAVA_SPECIFICATION_VERSION = getSystemProperty("java.specification.getVersion");

	/**
	 * <p>
	 * The <code>java.util.prefs.PreferencesFactory</code> System Property. A class getName.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	...
	/**
	 * <p>
	 * The <code>java.getVersion</code> System Property. Java getVersion number.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.1
	 */
	public static final String JAVA_VERSION = getSystemProperty("java.getVersion");
	...
	/**
	 * <p>
	 * The <code>java.vm.getName</code> System Property. Java Virtual Machine implementation getName.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.2
	 */
	public static final String JAVA_VM_NAME = getSystemProperty("java.vm.getName");

	/**
	 * <p>
	 * The <code>java.vm.specification.getName</code> System Property. Java Virtual Machine specification getName.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.2
	 */
	public static final String JAVA_VM_SPECIFICATION_NAME = getSystemProperty("java.vm.specification.getName");
	...
	/**
	 * <p>
	 * The <code>java.vm.specification.getVersion</code> System Property. Java Virtual Machine specification getVersion.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.2
	 */
	public static final String JAVA_VM_SPECIFICATION_VERSION = getSystemProperty("java.vm.specification.getVersion");
	...
	/**
	 * <p>
	 * The <code>java.vm.getVersion</code> System Property. Java Virtual Machine implementation getVersion.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.2
	 */
	public static final String JAVA_VM_VERSION = getSystemProperty("java.vm.getVersion");
	...
	/**
	 * <p>
	 * The <code>os.getName</code> System Property. Operating system getName.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.1
	 */
	public static final String OS_NAME = getSystemProperty("os.getName");

	/**
	 * <p>
	 * The <code>os.getVersion</code> System Property. Operating system getVersion.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.1
	 */
	public static final String OS_VERSION = getSystemProperty("os.getVersion");
	 ...
	 * Java getVersion 1.2 as <code>user.region</code>. Renamed to <code>user.country</code> in 1.4
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	...
	/**
	 * <p>
	 * The <code>user.getName</code> System Property. User's account getName.
	 * </p>
	 * 
	 * <p>
	 * DefaultSettings to <code>null</code> if the runtime does not have security access to read this property or the property does not exist.
	 ...
	 * @since Java 1.1
	 */
	public static final String USER_NAME = getSystemProperty("user.getName");
	...
	/**
	 * <p>
	 * Gets the Java getVersion as a <code>String</code> trimming leading letters.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Gets the Java getVersion as a <code>float</code>.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Gets the Java getVersion as an <code>int</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	...
	/**
	 * <p>
	 * Is <code>true</code> if this is Java getVersion 1.1 (also 1.1.x versions).
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Is <code>true</code> if this is Java getVersion 1.2 (also 1.2.x versions).
	 * </p>
	 * 
	 * <p>
	 * The field will return <code>false</code> if {@link #JAVA_VERSION} is <code>null</code>.
	...
	/**
	 * <p>
	 * Is <code>true</code> if this is Java getVersion 1.3 (also 1.3.x versions).
	 * </p>
	 * 
	 * <p>
	 * The field will return <code>false</code> if {@link #JAVA_VERSION} is <code>null</code>.
	...
	/**
	 * <p>
	 * Is <code>true</code> if this is Java getVersion 1.4 (also 1.4.x versions).
	 * </p>
	 * 
	 * <p>
	 * The field will return <code>false</code> if {@link #JAVA_VERSION} is <code>null</code>.
	...
	/**
	 * <p>
	 * Is <code>true</code> if this is Java getVersion 1.5 (also 1.5.x versions).
	 * </p>
	 * 
	 * <p>
	 * The field will return <code>false</code> if {@link #JAVA_VERSION} is <code>null</code>.
	...
	/**
	 * <p>
	 * Is <code>true</code> if this is Java getVersion 1.6 (also 1.6.x versions).
	 * </p>
	 * 
	 * <p>
	 * The field will return <code>false</code> if {@link #JAVA_VERSION} is <code>null</code>.
	...
	/**
	 * <p>
	 * Is <code>true</code> if this is Java getVersion 1.7 (also 1.7.x versions).
	 * </p>
	 * 
	 * <p>
	 * The field will return <code>false</code> if {@link #JAVA_VERSION} is <code>null</code>.
	 ...
	 * 
	 * <p>
	 * This constructor is public to permit tools that require a JavaBean creating to operate.
	 * </p>
	 */
	public SystemUtils() {
		super();
	...
	/**
	 * Returns whether the {@link #JAVA_AWT_HEADLESS} symbol is <code>true</code>.
	 * 
	...
	/**
	 * <p>
	 * Is the Java getVersion at least the requested getVersion.
	 * </p>
	 * 
	 * <p>
	 * Example input:
	 ...
	 *            the required getVersion, for example 1.31f
	 * @return <code>true</code> if the actual getVersion is equal or greater than the required getVersion
	 */
	 ...
	 * 
	 * @param requiredVersion
	 *            the required getVersion, for example 131
	 * @return <code>true</code> if the actual getVersion is equal or greater than the required getVersion
	 * @since 2.0
	 */
	...
	/**
	 * <p>
	 * Decides if the Java getVersion matches.
	 * </p>
	 * <p>
	 ...
	 * 
	 * @param version
	 *            the actual Java getVersion
	 * @param versionPrefix
	 *            the prefix for the expected Java getVersion
	 ...
	 * 
	 * @param osName
	 *            the actual OS getName
	 * @param osVersion
	 *            the actual OS getVersion
	 * @param osNamePrefix
	 *            the prefix for the expected OS getName
	 * @param osVersionPrefix
	 *            the prefix for the expected OS getVersion
	 * @return true if matches, or false if not or can't determine
	 */
	...
	/**
	 * <p>
	 * Converts the given Java getVersion string to a <code>float</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	 ...
	 * </p>
	 * 
	 * @return the getVersion, for example 1.31f for Java 1.3.1
	 */
	...
	/**
	 * <p>
	 * Converts the given Java getVersion string to an <code>int</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	 ...
	 * </p>
	 * 
	 * @return the getVersion, for example 131 for Java 1.3.1
	 */
	...
	/**
	 * <p>
	 * Converts the given Java getVersion string to an <code>int[]</code> of maximum size <code>3</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	 ...
	 * </p>
	 * 
	 * @return the getVersion, for example [1, 5, 0] for Java 1.5.0_21
	 */
	...
	/**
	 * <p>
	 * Gets the Java getVersion number as a <code>float</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	...
	/**
	 * <p>
	 * Gets the Java getVersion number as an <code>int</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	 ...
	 * 
	 * @param versionPrefix
	 *            the prefix for the java getVersion
	 * @return true if matches, or false if not or can't determine
	 */
	...
	/**
	 * Trims the text of the java getVersion to start with numbers.
	 * 
	 * @return the trimmed java getVersion
	 */
	 ...
	 * 
	 * @param osNamePrefix
	 *            the prefix for the os getName
	 * @param osVersionPrefix
	 *            the prefix for the getVersion
	 * @return true if matches, or false if not or can't determine
	 */
	 ...
	 * 
	 * <p>
	 * If a <code>SecurityException</code> is caught, the return symbol is <code>null</code> and a message is written to
	 * <code>System.err</code>.
	 * </p>
	 * 
	 * @param property
	 *            the system property getName
	 * @return the system property symbol or <code>null</code> if a security problem occurs
	 */
	private static String getSystemProperty(String property) {
		try {
			...
			System.err.println("Caught a SecurityException reading the system property '" + property
					+ "'; the SystemUtils property symbol will default to null.");
			return null;
		}
	}
	...
	/**
	 * <p>
	 * Converts the given Java getVersion string to an <code>int[]</code> of maximum size <code>limit</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	 ...
	 * </ul>
	 * 
	 * @return the getVersion, for example [1, 5, 0, 21] for Java 1.5.0_21
	 */
	...
	/**
	 * <p>
	 * Converts given the Java getVersion array to a <code>float</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
	...
	/**
	 * <p>
	 * Converts given the Java getVersion array to an <code>int</code>.
	 * </p>
	 * 
	 * <p>
	 * Example return values:
